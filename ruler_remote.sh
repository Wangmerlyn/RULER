...
# Default values
MODEL_FRAMEWORK_EXTRA="vllm"
VLLM_WORKER_MULTIPROC_METHOD="spawn"
# use anwser prefix = 1 is for original
RULER_USE_ANSWER_PREFIX=0
RULER_TEMPERATURE=0.6
# use RULER_TOKENS_TO_GENERATE= for the original
RULER_TOKENS_TO_GENERATE=8192
RULER_EVAL_POSTPROCESS="r1"
INSTALL_ENV=1
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    --model_framework_extra)
      MODEL_FRAMEWORK_EXTRA="$2"
      shift 2
      ;;
    --vllm_worker_multiproc_method)
      ...
      shift 2
      ;;
    --ruler_use_answer_prefix)
      RULER_USE_ANSWER_PREFIX="$2"
      shift 2
      ;;
    --ruler_temperature)
      RULER_TEMPERATURE="$2"
    ...
    --ruler_tokens_to_generate)
      RULER_TOKENS_TO_GENERATE="$2"
      shift 2
      ;;
    --ruler_eval_postprocess)
      RULER_EVAL_POSTPROCESS="$2"
      shift 2
      ;;
    --test_model_path)
      TEST_MODEL_PATH="$2"
...
export MODEL_FRAMEWORK_EXTRA
export VLLM_WORKER_MULTIPROC_METHOD
export RULER_USE_ANSWER_PREFIX
export RULER_TEMPERATURE
export RULER_TOKENS_TO_GENERATE
export RULER_EVAL_POSTPROCESS
export INSTALL_ENV
export TEST_MODEL_PATH
export TEMPALTE
export TEST_LENS
